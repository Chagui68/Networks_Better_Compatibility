...
import io.github.sefiraat.networks.utils.EnchantmentUtils;
...
/**
 * Creating SlimefunItemstacks here due to some items being created in Enums so
 * this will
...
public class NetworksSlimefunItemStacks {
        ...
        // Materials
        public static SlimefunItemStack SYNTHETIC_EMERALD_SHARD;
        public static SlimefunItemStack OPTIC_GLASS;
        public static SlimefunItemStack OPTIC_CABLE;
        public static SlimefunItemStack OPTIC_STAR;
        public static SlimefunItemStack RADIOACTIVE_OPTIC_STAR;
        public static SlimefunItemStack SHRINKING_BASE;
        public static SlimefunItemStack SIMPLE_NANOBOTS;
        public static SlimefunItemStack ADVANCED_NANOBOTS;
        public static SlimefunItemStack AI_CORE;
        public static SlimefunItemStack EMPOWERED_AI_CORE;
        public static SlimefunItemStack PRISTINE_AI_CORE;
        public static SlimefunItemStack INTERDIMENSIONAL_PRESENCE;

        // Network Items
        public static SlimefunItemStack NETWORK_CONTROLLER;
        public static SlimefunItemStack NETWORK_BRIDGE;
        public static SlimefunItemStack NETWORK_MONITOR;
        public static SlimefunItemStack NETWORK_IMPORT;
        public static SlimefunItemStack NETWORK_EXPORT;
        public static SlimefunItemStack NETWORK_GRABBER;
        public static SlimefunItemStack NETWORK_PUSHER;
        public static SlimefunItemStack NETWORK_CONTROL_X;
        public static SlimefunItemStack NETWORK_CONTROL_V;
        public static SlimefunItemStack NETWORK_VACUUM;
        public static SlimefunItemStack NETWORK_VANILLA_GRABBER;
        public static SlimefunItemStack NETWORK_VANILLA_PUSHER;
        public static SlimefunItemStack NETWORK_WIRELESS_TRANSMITTER;
        public static SlimefunItemStack NETWORK_WIRELESS_RECEIVER;
        public static SlimefunItemStack NETWORK_PURGER;
        public static SlimefunItemStack NETWORK_GRID;
        public static SlimefunItemStack NETWORK_CRAFTING_GRID;
        public static SlimefunItemStack NETWORK_CELL;
        public static SlimefunItemStack NETWORK_GREEDY_BLOCK;
        public static SlimefunItemStack NETWORK_QUANTUM_WORKBENCH;
        public static SlimefunItemStack NETWORK_QUANTUM_STORAGE_1;
        public static SlimefunItemStack NETWORK_QUANTUM_STORAGE_2;
        public static SlimefunItemStack NETWORK_QUANTUM_STORAGE_3;
        public static SlimefunItemStack NETWORK_QUANTUM_STORAGE_4;
        public static SlimefunItemStack NETWORK_QUANTUM_STORAGE_5;
        public static SlimefunItemStack NETWORK_QUANTUM_STORAGE_6;
        public static SlimefunItemStack NETWORK_QUANTUM_STORAGE_7;
        public static SlimefunItemStack NETWORK_QUANTUM_STORAGE_8;
        public static SlimefunItemStack NETWORK_CAPACITOR_1;
        public static SlimefunItemStack NETWORK_CAPACITOR_2;
        public static SlimefunItemStack NETWORK_CAPACITOR_3;
        public static SlimefunItemStack NETWORK_CAPACITOR_4;
        public static SlimefunItemStack NETWORK_POWER_OUTLET_1;
        public static SlimefunItemStack NETWORK_POWER_OUTLET_2;
        public static SlimefunItemStack NETWORK_POWER_DISPLAY;
        public static SlimefunItemStack NETWORK_RECIPE_ENCODER;
        public static SlimefunItemStack NETWORK_AUTO_CRAFTER;
        public static SlimefunItemStack NETWORK_AUTO_CRAFTER_WITHHOLDING;

        // Tools
        public static SlimefunItemStack CRAFTING_BLUEPRINT;
        public static SlimefunItemStack NETWORK_PROBE;
        public static SlimefunItemStack NETWORK_REMOTE;
        public static SlimefunItemStack NETWORK_REMOTE_EMPOWERED;
        public static SlimefunItemStack NETWORK_REMOTE_PRISTINE;
        public static SlimefunItemStack NETWORK_REMOTE_ULTIMATE;
        public static SlimefunItemStack NETWORK_CRAYON;
        public static SlimefunItemStack NETWORK_CONFIGURATOR;
        public static SlimefunItemStack NETWORK_WIRELESS_CONFIGURATOR;
        public static SlimefunItemStack NETWORK_RAKE_1;
        public static SlimefunItemStack NETWORK_RAKE_2;
        public static SlimefunItemStack NETWORK_RAKE_3;
        public static SlimefunItemStack NETWORK_DEBUG_STICK;
        ...
        public static void setup() {
                ...
                RADIOACTIVE_OPTIC_STAR = Theme.themedSlimefunItemStack(
                                ...
                                getPreEnchantedItemStack(Material.NETHER_STAR, true,
                                                new Pair<>(EnchantmentUtils.getEnchantment("power"), 1)),
                                Theme.CRAFTING,
                ...
                SHRINKING_BASE = Theme.themedSlimefunItemStack(
                                "NTW_SHRINKING_BASE",
                                getPreEnchantedItemStack(Material.PISTON, true,
                                                new Pair<>(EnchantmentUtils.getEnchantment("power"), 1)),
                                Theme.CRAFTING,
                                "Shrinking Base",
                ...
                ADVANCED_NANOBOTS = Theme.themedSlimefunItemStack(
                                ...
                                getPreEnchantedItemStack(Material.MELON_SEEDS, true,
                                                new Pair<>(EnchantmentUtils.getEnchantment("power"), 1)),
                                Theme.CRAFTING,
                                "Advanced Nanobots",
                                "Teeny Tiny little bots that can",
                ...
                PRISTINE_AI_CORE = Theme.themedSlimefunItemStack(
                                ...
                                getPreEnchantedItemStack(Material.TUBE_CORAL_BLOCK, true,
                                                new Pair<>(EnchantmentUtils.getEnchantment("power"), 1)),
                                Theme.CRAFTING,
                                "Pristine A.I. Core",
                ...
                INTERDIMENSIONAL_PRESENCE = Theme.themedSlimefunItemStack(
                                ...
                                getPreEnchantedItemStack(Material.ARMOR_STAND, true,
                                                new Pair<>(EnchantmentUtils.getEnchantment("power"), 1)),
                                Theme.CRAFTING,
                ...
                NETWORK_CONTROLLER = Theme.themedSlimefunItemStack(
                                ...
                                Theme.MACHINE,
                                "Network Controller", "The Network controller is the brain",
                ...
                NETWORK_BRIDGE = Theme.themedSlimefunItemStack(
                                ...
                                Theme.MACHINE,
                                "Network Bridge", "The bridge allows you to cheaply",
                ...
                NETWORK_CONTROL_X = Theme.themedSlimefunItemStack(
                                ...
                                "inventories.",
                                "",
                                MessageFormat.format("{0}Network Drain: {1}{2}/cut", Theme.CLICK_INFO, Theme.PASSIVE,
                                                100));
                ...
                NETWORK_CONTROL_V = Theme.themedSlimefunItemStack(
                                ...
                                "",
                                MessageFormat.format("{0}Network Drain: {1}{2}/paste", Theme.CLICK_INFO, Theme.PASSIVE,
                                                100));
                ...
                NETWORK_VACUUM = Theme.themedSlimefunItemStack(
                                ...
                                "into the Network.",
                                "",
                                MessageFormat.format("{0}Network Drain: {1}{2}/tick", Theme.CLICK_INFO, Theme.PASSIVE,
                                                100));
                ...
                NETWORK_RECIPE_ENCODER = Theme.themedSlimefunItemStack(
                                ...
                                "from input items.",
                                "",
                                MessageFormat.format("{0}Network Drain: {1}{2}/encode", Theme.CLICK_INFO, Theme.PASSIVE,
                                                20000));
                ...
                NETWORK_AUTO_CRAFTER = Theme.themedSlimefunItemStack(
                                ...
                                "materials.",
                                "",
                                MessageFormat.format("{0}Network Drain: {1}{2}/craft", Theme.CLICK_INFO, Theme.PASSIVE,
                                                64));
                ...
                NETWORK_REMOTE = Theme.themedSlimefunItemStack(
                                ...
                                "",
                                MessageFormat.format("{0}Range: {1}{2}", Theme.CLICK_INFO, Theme.PASSIVE,
                ...
                NETWORK_REMOTE_ULTIMATE = Theme.themedSlimefunItemStack(
                                "NTW_REMOTE_ULTIMATE",
                                getPreEnchantedItemStack(Material.GLOW_ITEM_FRAME, true,
                                                new Pair<>(EnchantmentUtils.getEnchantment("power"), 1)),
                                Theme.TOOL,
                ...
                NETWORK_CONFIGURATOR = Theme.themedSlimefunItemStack(
                                ...
                                "interfaces.",
                                "",
                                MessageFormat.format("{0}Right Click: {1}{2}", Theme.CLICK_INFO, Theme.PASSIVE,
                                                "Apply Config"),
                                MessageFormat.format("{0}Shift Right Click: {1}{2}", Theme.CLICK_INFO, Theme.PASSIVE,
                                                "Store Config"));
                ...
                NETWORK_WIRELESS_CONFIGURATOR = Theme.themedSlimefunItemStack(
                                ...
                                "",
                                MessageFormat.format("{0}Right Click: {1}{2}", Theme.CLICK_INFO, Theme.PASSIVE,
                                                "Store Receiver Location"),
                                MessageFormat.format("{0}Shift Right Click: {1}{2}", Theme.CLICK_INFO, Theme.PASSIVE,
                                                "Set Location to Transmitter"));
                ...
                NETWORK_RAKE_3 = Theme.themedSlimefunItemStack(
                                ...
                                getPreEnchantedItemStack(Material.WEEPING_VINES, true,
                                                new Pair<>(EnchantmentUtils.getEnchantment("luck_of_the_sea"), 1)),
                                Theme.TOOL,
                                "Network Rake (3)",
                                "Right click a Network Object to",
                                "break it instantly.",
